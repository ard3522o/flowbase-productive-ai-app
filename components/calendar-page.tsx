...
export function CalendarPage() {
  ...
  return <main className="flex min-h-screen bg-[#fbfcff] text-slate-900">
    <aside className="sticky top-0 hidden h-screen w-[210px] shrink-0 flex-col border-r border-slate-200/80 bg-white/95 px-3 py-4 lg:flex">
      <Link href="/" className="flex items-center gap-2.5 px-1"><span className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-violet-600 to-indigo-600 shadow-xl shadow-violet-300"><Menu className="h-5 w-5 text-white" /></span><span className="text-[15px] font-bold tracking-tight">Flowbase</span></Link>
